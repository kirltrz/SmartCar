...
#define AD_CS2_HIGH()           HAL_GPIO_WritePin(AD_CS2_GPIO_Port,AD_CS2_Pin,GPIO_PIN_SET);
#define AD_CS2_LOW()            HAL_GPIO_WritePin(AD_CS2_GPIO_Port,AD_CS2_Pin,GPIO_PIN_RESET);
...
extern uint16_t Conve_data[2][8];          // 滤波数值		
